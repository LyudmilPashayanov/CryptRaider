...
void ACryptRaiderCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(GrabAction, ETriggerEvent::Started, this, &ACryptRaiderCharacter::GrabItem);
		EnhancedInputComponent->BindAction(GrabAction, ETriggerEvent::Completed, this, &ACryptRaiderCharacter::ReleaseItem);
	}
}

void ACryptRaiderCharacter::GrabItem(const FInputActionValue& Value)
{
	MyGrabber->GrabItem();
}

void ACryptRaiderCharacter::ReleaseItem(const FInputActionValue& Value)
{
	MyGrabber->ReleaseItem();
}
...
void ACryptRaiderCharacter::SetGrabber(UGrabber* newGrabber)
{
	MyGrabber = newGrabber;
}
