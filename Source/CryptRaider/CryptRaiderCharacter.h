...
#include "Grabber.h" // Include the header file for UGrabber
...
class ACryptRaiderCharacter : public ACharacter
{
	...
	void ReleaseItem(const FInputActionValue& Value);
	...
	/** Move Input Action */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=rodger, meta=(AllowPrivateAccess = "true"))
